...
## Source Code
The R code used for data exploration, regression modeling, model selection, and diagnostic analysis is available here:
https://github.com/Therancearizi/real-estate-valuation-regression/blob/main/Rcode
